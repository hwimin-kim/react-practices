...
export default function App() {
    ...
    const onBlurInput =  e => console.log('blured');
    ...
    const onClickImage =  e => console.log('mouseclick', `x=${e.clientX}, y=${e.clientY}`);
    const onDoubleClickImage =  e => console.log('mousedbclick', `x=${e.clientX}, y=${e.clientY}`);
